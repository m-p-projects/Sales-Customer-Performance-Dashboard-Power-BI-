...
* **Theme:** Accessible City Park (Customized for high contrast and readability)
* **Calculations:** Advanced DAX (Data Analysis Expressions) including Time Intelligence and Ranking.

---

## 3. Data Architecture & Modeling
The project utilizes a robust **Star Schema** to optimize query performance and ensure a clear "single source of truth" for the business.
...
* **Modeling Best Practices:** Implemented one-to-many ($1:*$) relationships and ensured accurate filter propagation across all report pages.
...
## 5. Visual Design & UX
* **Accessibility First:** Utilized an accessible color palette to ensure the report is inclusive for users with visual impairments.
